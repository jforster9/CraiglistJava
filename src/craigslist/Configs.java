...
public class Configs
{
	...
	protected static float read_float_entry(String sectionName, String option)
	{
		Ini.Section section = clConfig.get(sectionName);
		return section.get(option, float.class);
	}
	...
	protected static boolean read_bool_entry(String sectionName, String option)
	{
		Ini.Section section = clConfig.get(sectionName);
		return section.get(option, boolean.class);
	}
